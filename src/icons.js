...
export const TODAY_TREND_FACTION_ICON_SVG = icon('<circle cx="12" cy="5" r="2.5"/><circle cx="5.5" cy="18" r="2.5"/><circle cx="18.5" cy="18" r="2.5"/><path d="m10.8 7.2-4 8M13.2 7.2l4 8"/>');
export const TODAY_TREND_DYNAMICS_ICON_SVG = icon('<path d="M3 13h4l2.5-8 4.5 15 3-9H21"/>');
