...
export const RECIPE_ICON_SVG = icon('<path d="M5 10h14v8a3 3 0 0 1-3 3H8a3 3 0 0 1-3-3z"/><path d="M3 10h18M8 6c1 1 2 2.2 2 4M12 5c.7 1.3 1 3 0 5M16 6c-1 1-2 2.2-2 4"/>');
export const CYCLE_PERIOD_ICON_SVG = icon('<path d="M6 5c2.5 0 3 2.4 6 2.4S15.5 5 18 5v5.1c-2.5 0-3 2.4-6 2.4s-3.5-2.4-6-2.4z"/><path d="M6 10.1c2.5 0 3 2.4 6 2.4s3.5-2.4 6-2.4V16c-2.5 0-3 2.4-6 2.4S8.5 16 6 16z"/>');
...
export const CYCLE_SAFE_ICON_SVG = icon('<path d="M5 7c2.5-2.4 5.4-2.2 7 1 1.6-3.2 4.5-3.4 7-1-1 4.4-3.4 7.3-7 11-3.6-3.7-6-6.6-7-11z"/><path d="M8.5 7.5l2 2M15.5 7.5l-2 2"/>');
