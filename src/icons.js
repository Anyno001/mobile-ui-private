...
export const STOP_ICON_SVG = icon('<rect x="7" y="7" width="10" height="10" rx="1"/>');
...
export const TODAY_TREND_REPUTATION_ICON_SVG = icon('<circle cx="10" cy="8" r="3"/><path d="M4 20c.4-3.8 2.5-6 6-6s5.6 2.2 6 6M19 5v4M17 7h4"/>');
export const TODAY_TREND_FACTION_ICON_SVG = icon('<circle cx="6" cy="7" r="2"/><circle cx="18" cy="7" r="2"/><circle cx="12" cy="18" r="2"/><path d="M7.7 8.1l2.8 7.1M16.3 8.1l-2.8 7.1M8 7h8"/>');
