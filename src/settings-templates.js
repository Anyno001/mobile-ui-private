...
export function resolveBudgetPercentageInput({
    sourceWeights, phone, community, calendar, recipe, outfit, todayTrend,
    initialPhone, initialCommunity, initialCalendar, initialRecipe, initialOutfit, initialTodayTrend,
}) {
