...
for (const expected of [
  ...
  'aria-label="拍一拍本帖，只生成本帖评论"', "class=\"pm-scene-share ${post.shareCount > 0 ? 'is-shared' : ''}\"", "post.shareCount > 0 ? '再次分享本帖' : '分享本帖'", "renderPostMetric(SHARE_ICON_SVG, shares, '转发', 'is-share')",
