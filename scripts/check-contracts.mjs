...
for (const expected of [
  'HEART_ICON_SVG', 'SHARE_ICON_SVG', 'REPLY_ICON_SVG', 'SEND_ICON_SVG', 'CONTROL_ICON_SVG', 'FEED_ICON_SVG', 'LIVE_ICON_SVG', 'EDIT_ICON_SVG', 'TRASH_ICON_SVG',
  ...
  'data-action="edit-comment"', 'aria-label="编辑评论"', 'data-action="delete-comment"', 'aria-label="删除评论"',
...
for (const expected of [
  ...
  '.pm-scene-topbar{grid-template-columns:42px minmax(0,1fr) 42px',
  '@media(max-width:320px){.pm-scene-topbar{grid-template-columns:36px minmax(0,1fr) 36px',
